  ...
  section.innerHTML = 
    `<header>
      ...
      <p>
        ...
        Com o propósito de uma calculadora de IMC.
      </p>
      <a
        href="https://github.com/paulogvinicius?tab=repositories"
        target="_blank"
      >
        <svg
    ...
    <div class="content">
      <div class="cards">
        <div class="card">
          ...
          <div class="img-wrapper">
            <img
              ...
              alt="Calculadora IMC imagem"
            />
            <div class="buttons">
              <a
                href="https://github.com/paulogvinicius/Calculadora-de-IMC"
                target="_blank"
              ...
              <a href="https://calculadora-de-imc-mauve.vercel.app/" 
              target="_blank"
              title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
          ...
          <p>
          Descrição do projeto Calculadore IMC.
          </p>
        </div>
        <div class="card">
          <h3>Desafio 2</h3>
          <div class="img-wrapper">
            ...
            <div class="buttons">
              <a
                href="https://github.com/paulogvinicius/FocusTimer"
                target="_blank"
                title="Repositório no Github"
              >
                <svg
              ...
              <a
                href="https://focus-timer-nu.vercel.app/"
                target="_blank"
                title="Ver Projeto"
              >
                <svg
          ...
          <p>Um projeto de timer que utiliza módulos ES6, que possui um Dark Light Mode, contador e som.</p>
          <p>HTML - CSS - JS - NODE.JS</p>
        </div>
        <div class="card">
          <h3>Desafio 3</h3>
          <div class="img-wrapper">
            <img src="imagens/fabricadebilionarios.png" />
            <div class="buttons">
              <a
                href="https://github.com/paulogvinicius/Site-para-ebook---03"
                target="_blank"
                title="Repositório no Github"
              >
                <svg
              ...
              <a
                href="https://site-para-ebook-03.vercel.app/"
                target="_blank"
                title="Ver Projeto"
              >
                <svg
          ...
          <p>Site de vendas do E-Book Fabrica de Bilionarios</p>
          <p>HTML - CSS</p>
        </div>
        <div class="card">
          <h3>Desafio 4</h3>
          <div class="img-wrapper">
            ...
            <div class="buttons">
              <a
                href="https://github.com/paulogvinicius/Jogo-Adivinhacao"
                target="_blank"
                title="Repositório no Github"
              >
                <svg
              ...
              <a
                href="https://jogo-adivinhacao-dun.vercel.app/"
                target="_blank"
                title="Ver Projeto"
              >
                <svg
          ...
          <p>Descrição jogo da adivinhação.</p>
          <p>HTML - CSS- JS</p>
        </div>
        <div class="card">
          <h3>Desafio 5</h3>
          <div class="img-wrapper">
            <img src="imagens/portifilio.png" alt="Imagem do projeto." />
            <div class="buttons">
              <a href="https://github.com/paulogvinicius/Portif-lio-" target="_blank" title="Repositório no Github">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <a href="https://www.pauloviniciusdev.com.br/" target="_blank" title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
          ...
          <p>
          Descrição de projeto portifolio.
          </p>
          <p>HTML - CSS</p>
        </div>
        <div class="card">
          <h3>Desafio 6</h3>
          <div class="img-wrapper">
            <img src="imagens/siterocketseat.png" />
            <div class="buttons">
              <a href="https://github.com/paulogvinicius/Projeto-Rocketseat" target="_blank" title="Repositório no Github">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <a href="https://projeto-rocketseat-dusky.vercel.app/" target="_blank" title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
          ...
          <p>
          Projeto de site desenvolvido na Rocketseat.
          </p>
          <p>HTML - CSS</p>
        </div>
        <div class="card">
          <h3>Desafio 7</h3>
          <div class="img-wrapper">
            <img src="imagens/sitegaláxias.png" alt="Imagem do projeto." />
            <div class="buttons">
              <a href="https://github.com/paulogvinicius/Galaxias" target="_blank" title="Repositório no Github">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <a href="https://galaxias-kappa.vercel.app/" target="_blank" title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
        ...
        <div class="card">
          <h3>Desafio 8</h3>
          <div class="img-wrapper">
            <img src="imagens/sitenode.png" />
            <div class="buttons">
              <a href="https://github.com/paulogvinicius/site-node.js" target="_blank" title="Repositório no Github">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <a href="https://site-node-js-taupe.vercel.app/" target="_blank" title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
        ...
        <div class="card">
          <h3>Desafio 9</h3>
          <div class="img-wrapper">
            <img src="imagens/aline.png" />
            <div class="buttons">
              <a href="https://github.com/paulogvinicius/Projeto-Portifolio" target="_blank" title="Repositório no Github">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
              ...
              <a href="https://projeto-portifolio-flame.vercel.app/" target="_blank" title="Ver Projeto">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
                  width="24"
